...
const Registration = () => {
  ...
  return (
    <Fragment>
      <Container className="bg-info clearfix" style={{ padding: "2em", color: "#FFF" }}>
        <Row>
          <Col sm="12" md={{ size: 6, offset: 3 }}>
            <form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
              <FormGroup>
                <Label for="Name">Name</Label>
                <Input type="text" name="name" innerRef={register} invalid={!!errors.name} />
                <div className="text-danger">{errors.name && errors.name.message}</div>
              </FormGroup>
              <FormGroup>
                <Label for="Email">Email</Label>
                <Input type="email" name="email" innerRef={register} invalid={!!errors.email} />
                <div className="text-danger">{errors.email && errors.email.message}</div>
              </FormGroup>
              <FormGroup>
                <Label for="password">Password</Label>
                <Input type="password" name="password" innerRef={register} invalid={!!errors.password} />
              ...
              <FormGroup>
                ...
                />
                <div className="text-danger">{errors.confirm_password && errors.confirm_password.message}</div>
              </FormGroup>
